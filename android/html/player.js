			function init() {
				...
				var sides = [
					{
						url: './test/cube/Bridge2/posx.jpg',
						position: new THREE.Vector3( -512, 0, 0 ),
						rotation: new THREE.Vector3( 0, Math.PI / 2, 0 )
					},
					{
						url: './test/cube/Bridge2/negx.jpg',
						position: new THREE.Vector3( 512, 0, 0 ),
						rotation: new THREE.Vector3( 0, -Math.PI / 2, 0 )
					},
					{
						url: './test/cube/Bridge2/posy.jpg',
						position: new THREE.Vector3( 0,  512, 0 ),
						rotation: new THREE.Vector3( Math.PI / 2, 0, Math.PI )
					},
					{
						url: './test/cube/Bridge2/negy.jpg',
						position: new THREE.Vector3( 0, -512, 0 ),
						rotation: new THREE.Vector3( - Math.PI / 2, 0, Math.PI )
					},
					{
						url: './test/cube/Bridge2/posz.jpg',
						position: new THREE.Vector3( 0, 0,  512 ),
						rotation: new THREE.Vector3( 0, Math.PI, 0 )
					},
					{
						url: './test/cube/Bridge2/negz.jpg',
						position: new THREE.Vector3( 0, 0, -512 ),
